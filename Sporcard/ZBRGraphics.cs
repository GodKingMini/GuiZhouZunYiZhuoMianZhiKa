...
namespace Sporcard
{
	public class ZBRGraphics
    {
        ...
        //public void Rotation180(ref ZMotifGraphics g)
        //{
        //    int iDataLen = 0;
        //    byte[] byt = g.CreateBitmap(out iDataLen);
        //    g.ClearGraphics();
        //    g.InitGraphics(0, 0, ZMotifGraphics.ImageOrientationEnum.Landscape, ZMotifGraphics.RibbonTypeEnum.Color);
        //    g.ImageRotation = ZMotifGraphics.RotationTypeEnum.Rotate180FlipNone;
        //    //g.ImageFromByteArray(ref byt);
        //    g.DrawImage(ref byt, ZMotifGraphics.ImagePositionEnum.Centered, 1006, 640, 0);
        //}
